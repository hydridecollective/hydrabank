...
import { faArrowAltCircleDown, faClipboardCheck, faClock, faExternalLinkAlt, faMoneyBill } from "@fortawesome/free-solid-svg-icons";
...
function Home() {
  return (
    <div className="py-6">
        ...
        <div className="flex flex-row gap-x-4 mt-8">
          <div className="flex flex-col gap-y-2 rounded-xl border-gray-600 border-2 max-w-2xl">
            <div className="flex flex-row items-center gap-x-2 border-b-2 border-gray-600 py-4 px-4">
              ...
              <span className="text-lg font-semibold">Advanced Logging</span>
            </div>
            <div className="flex flex-col py-4 px-4 pt-2 gap-y-2">
              <p>
          ...
          <div className="flex flex-col gap-y-2 rounded-xl border-gray-600 border-2 max-w-2xl">
            <div className="flex flex-row items-center gap-x-2 border-b-2 border-gray-600 py-4 px-4">
              ...
              <span className="text-lg font-semibold">Quality and Excellence</span>
            </div>
            <div className="flex flex-col py-4 px-4 pt-2 gap-y-2">
              <p>
      ...
      <div className="flex flex-row gap-x-12 justify-center mt-4">
      ...
      <div className="flex flex-col py-20 text-center">
        ...
        <h2 className="text-white font-medium text-2xl font-BreezeHeader px-5 pt-2 pb-4 text-center">
          ...
          {" "}
          <span className="text-orange-400 md:text-orange-300 font-BreezeMono">
