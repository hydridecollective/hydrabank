      ...
      <div className="flex flex-col">
        <div className="flex min-h-screen">
          <div className="my-auto w-full flex flex-wrap justify-around p-16 px-10 sm:px-16">
            {renderCard(faTerminal, "Real Time Remote Monitoring", "Monitor your infrastructure with ease. Our powerful tools provide real-time insights into your system's performance, ensuring smooth operations and rapid issue resolution.")}
            {renderCard(faShield, "Advanced Security", "We prioritize a proactive security approach to safeguard your systems. With robust maintenance and advanced tools like Fail2Ban, IPTables, and UFW or Firewall, we ensure your production software and infrastructure remain secure, up-to-date, and reliable.")}
            {renderCard(faBook, "Advanced Logging", "We streamline SSH logging and backup reporting by organizing them into separate channels, allowing for effortless log browsing. Regular proactive checks are conducted to identify any inconsistencies or anomalies in the data streams, ensuring comprehensive monitoring and reporting.")}
